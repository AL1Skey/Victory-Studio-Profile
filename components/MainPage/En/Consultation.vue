                ...
                <div class="col-lg-7">
                    <div class="consultation-content">
                        <h1 class="tw-text-3xl tw-font-bold tw-text-blue-950 tw-mb-5">
                            We are a team of professional developers dedicated to helping your business grow through technology.
                        </h1>
                        <p data-aos="zoom-in-right">
                            We offer comprehensive web and mobile application development services to ensure your business is easily accessible across various platforms.
                        </p>
                        <div class="consultation-list">
                            <ul class="list-wrap">
                                <li data-aos="zoom-in-right">
                                    <PhoneIcon />
                                    <h6 class="title tw-ml-2">+62-819-3045-6886</h6>
                                </li>
                                <li data-aos="zoom-in-right">
                                    <MailIcon />
